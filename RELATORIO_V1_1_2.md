...
- A versão do sistema foi atualizada para `1.1.2`.

## Preservação da Versão Anterior

Antes da correção, a versão anterior foi preservada no GitHub em:
...
A tabela de atividades continua preparada no banco, mas a tela de registro de atividade permanece como placeholder para implementação futura.
